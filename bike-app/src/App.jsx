    ...
    <main>
      <div className="App">
        ...
        <div className="nav-menu">
          <Link to='/absproxy/8081'>Products</Link>
          <Link to='/absproxy/8081/order_history'>Order History</Link>
        ...
        <div className="flex-mid">
          <Routes>
            <Route path="/absproxy/8081" element={<Products />} />
            <Route path="/absproxy/8081/order_history" element={<OrderHistory />} />
            <Route path="/absproxy/8081/lookup_order/:orderId" element={<OrderDetails />} />
          </Routes>
